...
<?php 
  $title = "Trang chủ - MobiArmy 2 by Ann"; 
  include './include/head.php';
?>
                
    <div class="bg_top_22">
        <div class="w3-content w3-display-container">
            <img class="mySlides" src="/public/images/mobiarmy2v.jpg" alt="MobiArmy II" style="width:100%">
        </div>
        <script>
            var myIndex = 0;
            carousel();
...
<div class="bg-content">
    <div>
        <div class="title">
            <h4>Giới Thiệu ( Game như Gunny thôi, dưới là văn mẫu đấy )</h4>
        </div>
...
<div class="bg-content">
    <div>
        ...
        <div class="content">
            ...
            <p>- MobiArmy II by Ann không sử dụng chung tài khoản với bất kì game nào!
                <br /> - Bạn có thể đăng kí miễn phí ngay <a href="/register.php" style="color: black"><b>tại đây</b></a>
...
<div class="bg-content">
    <div>
        ...
        <div class="content">
            ...
            <p>- Nếu bạn sử dụng máy tính đang chạy Windows, bạn hãy tải <b><a href="/download/pc/KEmulator-JavaEmulator.zip" style="color: black">giả lập giành cho máy tính.</a></b></p>

            <p>- Game lại chưa hỗ trợ IOS, nếu bạn tìm được phiên bản giả lập jar cho IOS có thể thử.</p>
        </div>
    </div>
</div>
	</div>
