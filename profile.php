...
<div class="bg-content" style="text-align:right">Xin chào <?php echo $user['user'] ?>,
  <a href="/logout.php" style="color:seagreen"><b>Đăng xuất!</b></a>
</div>
<div class="bg-content content">
  <?php
    if (!$createdCharacter) {
      echo '<div class="bg-content" style="text-align:right">Vui lòng đăng nhập vào game để tạo nhân vật,<a href="/logout.php" style="color:seagreen"><b>Đăng xuất!</b></a></div></div>';
  ...
  <ul>
    <li>
      <a style="color: #4e452a" href="/changepassword.php" title="Đổi Mật Khẩu">Đổi Mật Khẩu</a>
    </li>
	 <li>
      <a style="color: #4e452a" href="/changeuser.php" title="Đổi Mật Khẩu">Đổi Tên Nhân Vật</a>
    </li>
    <li>
      <a style="color: #4e452a" href="/napthe/" title="Nạp Tiền">Nạp Tiền</a>
    </li>
    <? if ($user['email'] == null ) { ?>
    <li>
      <a style="color: #4e452a" href="/addemail.php" title="Thêm email">Thêm Email</a>
    </li>
    <? } else { ?>
    <li>
      <a style="color: #4e452a" href="/changeemail.php" title="Đổi email">Đổi Email</a>
    </li>
    <? }
    if ($user['password2'] == '-1') { ?>
    <li>
      <a style="color: #4e452a" href="/addsignature.php" title="Thêm chữ ký">Thêm Chữ Ký</a>
    </li>
    <? } else { ?>
    <li>
      <a style="color: #4e452a" href="/changesignature.php" title="Đổi chữ ký">Đổi Chữ Ký</a>
    </li>
    <? }
    if ($user['password2'] != '-1' && $user['email'] != null) { ?>
    <li>
      <a style="color: #4e452a" href="/forgotsignature.php" title="Quên chữ ký">Quên Chữ Ký</a>
    </li>
    <? } ?>
    
    
    <li>
      <a style="color: #4e452a" href="/equip.php" title="Trang Bị">Mặc/Tháo Trang Bị</a>
    </li>
    <li>
      <a style="color: #4e452a" href="/addpoint.php" title="Cộng điểm">Cộng Điểm Nâng Cấp</a>
    </li>
    <li>
  ...
  ?>
  <div class="title">
    <h4 style="font-size: 13px">THÔNG TIN NHÂN VẬT <? echo $nameCharacter[$i]. ' <a onclick="view('.$user['user_id'].', '.$i.')" style="color:red">[Trang bị]</a>' ?></h4>
  </div>
  <table width="100%">
    <tr>
