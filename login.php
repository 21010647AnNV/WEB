<?php
  $title = "Đăng nhập - MobiArmy II by Ann";
  ...
  <div class="content">
    ...
    <div class="content" style="text-align:center">
      <form action="/login.php" method="POST">
        ...
        <a href="/forgotpassword.php" style="color:red">Bạn quên mật khẩu?</a>
        <p>Bạn chưa có tài khoản? <a href="/register.php" style="color:red">Đăng ký</a> ngay</p>
      <form>
    </div>
  </div>
</div>
