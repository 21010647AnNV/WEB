  ...
  <div class="content">
    ...
    <div class="title">
      ...
      <ul>
        ...
        <li>
          <a style="color: #4e452a" title="shop">Bạn đang có: <? echo $armymem['money']; ?> đồng</a><a style="color: red" href="https://www.facebook.com/nguyenan.362.crypto" title="shop"> Rút tiền</a>
          </li>
      </ul>
  </div>
  <div class="content">
